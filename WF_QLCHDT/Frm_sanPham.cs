    ...
    public partial class Frm_sanPham : Form
    {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0 && e.RowIndex < bangDuLieu.Rows.Count)
            {
                ...
                cbMaNCC.SelectedValue = bangDuLieu.Rows[donghh]["MaNCC"].ToString();
                ...
                cbMaLoai.SelectedValue = bangDuLieu.Rows[donghh]["MaLoai"].ToString();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string lenhTimKiem = $"SELECT * FROM sanpham WHERE MaSP LIKE '%{tuKhoa}%' OR TenSP LIKE '%{tuKhoa}%' OR MaNCC LIKE '%{tuKhoa}%' OR GiaSP LIKE '%{tuKhoa}%' OR HangSP LIKE '%{tuKhoa}%' OR XuatXuSP LIKE '%{tuKhoa}%' OR MaLoai LIKE '%{tuKhoa}%' OR SoLuongTonKho LIKE '%{tuKhoa}%'";
